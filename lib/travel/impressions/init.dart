...
_initCountries(var entries) {
  ...
  place = new Place(country.places.concept);
  place.name = 'Dariva';
  place.city = 'Sarajevo';
  ...
  country = new Country.withId(countries.concept, 'Croatia');
  country.code = 'HR';
  countries.add(country);

  place = new Place.withId(country.places.concept, country, 'Loviste');
  place.city = '';
  place.description = 'charming cost village';
  country.places.add(place);

  webLink = new WebLink.withId(place.webLinks.concept,
  ...
  country = new Country.withId(countries.concept, 'France');
  country.code = 'FR';
  countries.add(country);

  country = new Country.withId(countries.concept, 'Canada');
  country.code = 'CA';
  countries.add(country);
}
...
_initTravelers(var entries) {
  ...
  traveler = new Traveler.withId(travelers.concept, 'tim@gmail.com');
  ...
  traveler = new Traveler.withId(travelers.concept, 'ogi@gmail.com');
